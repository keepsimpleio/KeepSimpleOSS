...
const content: OffsecBiasContent = {
  ...
  visual: {
    ...
    after: {
      ...
      priorContext:
        'A busy morning: the notification stream fills up back to back, the dangerous grant sitting somewhere in it.',
      items: [
        { title: 'New sign-in from your usual device' },
        { title: 'Calendar synced successfully' },
      ...
      caption:
        'Same grant, same words, styled like every neighbor, now sitting midway down the morning stream. As the list grows, recognition of any one line collapses and the dangerous entry slides past unread.',
      flagged: true,
    },
  },
