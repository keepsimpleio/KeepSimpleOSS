...
const content: OffsecBiasContent = {
  ...
  scenario:
    'An app asks for permissions to connect to your calendar. The first line is ordinary, view your basic profile. The last line is ordinary, see your email address. In between, where your eyes glide and your memory drops off, sits the one that matters: read and send mail on your behalf. You approve the screen and later recall granting something reasonable, because the parts you remember, the first and the last, were reasonable. The attacker did not hide the dangerous scope. They positioned it where you would not hold onto it.',
  ...
  visual: {
    before: {
      ...
      steps: [
        ...
        {
          label: 'Place the dangerous scope in the middle',
          note: 'Read and send mail on your behalf. Mid-list is where recall and scrutiny bottom out.',
          active: true,
        },
        {
          label: 'Flank it with more mundane items',
          note: 'Surround the risky line with boring ones so nothing about it stands out.',
        },
        {
          label: 'Close with another harmless item',
          note: 'See your email address. The last line is remembered too, so the whole list feels tame.',
        },
      ],
    ...
    after: {
      ...
      scopes: [
        ...
        { label: 'Read and send mail on your behalf', risky: true },
