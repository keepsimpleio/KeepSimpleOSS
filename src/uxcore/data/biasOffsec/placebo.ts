...
const content: OffsecBiasContent = {
  ...
  visual: {
    ...
    after: {
      ...
      items: [
        { label: 'Browsing protected', state: 'ok', flagged: true },
        { label: 'Downloads scanned', state: 'ok', flagged: true },
        { label: 'Phishing blocked', state: 'ok', flagged: true },
        { label: 'Identity secured', state: 'ok', flagged: true },
        { label: 'Threats stopped today: 0', state: 'ok', flagged: true },
      ],
      footer: 'You are fully protected. Nothing to worry about.',
      flagged: true,
    },
  },
