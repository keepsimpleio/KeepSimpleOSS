...
const content: OffsecBiasContent = {
  ...
  visual: {
    ...
    after: {
      ...
      path: '/sso',
      pageHeading: 'Подтвердите SSO, чтобы оценить вашу утечку по NorthBank',
      pageBody:
