import { ILibraryCard, TShelfCard } from '@/types';
...
export const librariesData: ILibraryCard[] = Array.from({ length: 60 }, (_, i) => ({
  id: `Library ${i + 1}`,
  name: `Library ${i + 1}`,
...
export const navigationData: { label: string; Icon: React.ElementType; href: string }[] = [
  {
    label: 'UX Core',
    Icon: UxcoreIcon,
    href: '/',
