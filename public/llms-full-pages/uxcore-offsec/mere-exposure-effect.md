# Mere exposure effect in Offensive Cybersecurity

- URL: https://keepsimple.io/uxcore/cybersecurity/mere-exposure-effect
- Bias entry: https://keepsimple.io/uxcore/4-mere-exposure-effect
...
Weeks of pleasant, costless contact can be the runway for one expensive ask. If the request would fail coming from a stranger, familiarity is the only thing carrying it.
